...
func NewServer(cfg ServerConfig) *http.Server {
	...
	mux.Handle("POST /tenants/{slug}/suspend", api.provisionerAuth(http.HandlerFunc(api.suspendTenant)))
	mux.Handle("POST /tenants/{slug}/resume", api.provisionerAuth(http.HandlerFunc(api.resumeTenant)))
